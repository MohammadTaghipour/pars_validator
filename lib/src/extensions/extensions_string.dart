...
extension StringValidation on String {
  ...
  /// Example:
  /// ```dart
  /// String cleaned = 'سلام‌علیکم'.removeHalfSpaces(); // 'سلامعلیکم'
  /// ```
  String removeHalfSpaces() {
    return General.removeHalfSpaces(this);
  }
  ...
  /// Example:
  /// ```dart
  /// String formatted = 'سلام علیکم'.replaceSpacesWithHalfSpaces(); // 'سلام‌علیکم'
  /// ```
  String replaceSpacesWithHalfSpaces() {
    return General.replaceSpacesWithHalfSpaces(this);
  }
  ...
  /// Example:
  /// ```dart
  /// String normalized = 'سلام‌علیکم'.replaceHalfSpacesWithSpaces(); // 'سلام علیکم'
  /// ```
